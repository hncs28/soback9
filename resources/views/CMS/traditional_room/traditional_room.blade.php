...
<body>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <form method="POST" action="/CMS/traditional_room/destroy/{{$row->tradiID}}" onsubmit="return ConfirmDelete(this)">
                        @method('DELETE')
                        @csrf
    ...
    <p align="center">
        <a href="\CMS\traditional_room\create">
